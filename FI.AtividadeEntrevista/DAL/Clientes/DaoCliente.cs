...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal List<Beneficiario> PesquisaBeneficiarios(int iniciarEm, int quantidade, string campoOrdenacao, bool crescente, int idCliente, out int qtd)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            ...
            List<DML.Beneficiario> ben = ConverterBeneficiario(ds);
        ...
        internal bool VerificarExistenciaBeneficiario(string CPFBeneficiario, int idCliente)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();

            parametros.Add(new System.Data.SqlClient.SqlParameter("CPFBENEFICIARIO", CPFBeneficiario));
            parametros.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", idCliente));
